...
_NOTIFICATIONCATEGORY = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FRIEND_INVITE_RECEIVED', index=18, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FRIEND_INVITE_ACCEPTED', index=19, number=19,
      options=None,
      type=None),
  ],
...
FRIEND_INVITE_RECEIVED = 18
FRIEND_INVITE_ACCEPTED = 19
